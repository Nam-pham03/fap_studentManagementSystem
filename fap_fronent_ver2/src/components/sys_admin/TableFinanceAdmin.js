...
const TableFinanceAdmin = () => {
    ...
    const handleDownload = () => {
        ...
        link.download = 'finance_admins.csv';
        link.click();
    };
    ...
    return (
        <div className="p-6 flex-1 overflow-auto">
            <div className="bg-white p-6 rounded-lg shadow-md">
                <h2 className="text-lg font-bold mb-4">Finance Admin Management</h2>
...
export default TableFinanceAdmin;